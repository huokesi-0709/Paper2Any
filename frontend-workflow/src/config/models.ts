...
export const IMAGE_PLAYGROUND_MODELS = readEnvList('VITE_IMAGE_PLAYGROUND_MODEL', [
  'gpt-image-2',
  'gemini-3.1-flash-image-preview',
  'gemini-3-pro-image-preview',
  'gpt-image-2-all',
]);
export const DEFAULT_IMAGE_PLAYGROUND_MODEL = firstOr(IMAGE_PLAYGROUND_MODELS, 'gpt-image-2');
