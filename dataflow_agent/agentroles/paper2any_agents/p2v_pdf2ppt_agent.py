...
P2vPdf2ppt agent
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
生成时间: 2025-11-29 15:42:01
生成位置: dataflow_agent/agentroles/common_agents/p2v_pdf2ppt_agent.py

本文件由 `dfa create --agent_name p2v_pdf2ppt` 自动生成。
...
# Agent Definition
# ----------------------------------------------------------------------
@register("p2v_pdf2ppt")
class P2vPdf2ppt(BaseAgent):
    """TODO: 描述 p2v_pdf2ppt 的职责"""
    ...
    def system_prompt_template_name(self) -> str:
        # TODO: 修改为真实的模板 id
        return "system_prompt_for_p2v_pdf2ppt"

    @property
    def task_prompt_template_name(self) -> str:
        # TODO: 修改为真实的模板 id
        return "task_prompt_for_p2v_pdf2ppt"
