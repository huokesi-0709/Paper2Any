"""
P2vBeamerCodeUpgrade agent
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
生成时间: 2025-12-18 15:24:48
生成位置: dataflow_agent/agentroles/common_agents/p2v_beamer_code_upgrade_agent.py

本文件由 `dfa create --agent_name p2v_beamer_code_upgrade` 自动生成。
...
# Agent Definition
# ----------------------------------------------------------------------
@register("p2v_beamer_code_upgrade")
class P2vBeamerCodeUpgrade(BaseAgent):
    """p2v_beamer_code_upgrade 的职责: 优化图片的展示功能"""
    ...
    def role_name(self) -> str:
        return "p2v_beamer_code_upgrade"

    @property
    def system_prompt_template_name(self) -> str:
        return "system_prompt_for_p2v_beamer_code_upgrade"

    @property
    def task_prompt_template_name(self) -> str:
        return "task_prompt_for_p2v_beamer_code_upgrade"
    ...
    def update_state_result(
        ...
        state.img_size_debug = ast.literal_eval(result.get("img_size_debug", "True"))
...
# Helper APIs
# ----------------------------------------------------------------------
async def p2v_beamer_code_upgrade(
    state: MainState,
...
def create_p2v_beamer_code_upgrade(
    tool_manager: Optional[ToolManager] = None,
    model_name: Optional[str] = None,
    temperature: float = 0.0,
    max_tokens: int = 4096,
    ...
    vlm_config: Optional[Dict[str, Any]] = None,
    **kwargs,
) -> P2vBeamerCodeUpgrade:
    return P2vBeamerCodeUpgrade.create(
        tool_manager=tool_manager,
        model_name=model_name,
        temperature=temperature,
        max_tokens=max_tokens,
